...
AckMessage::AckMessage(const char *name, short kind) : ::veins::BaseFrame1609_4(name, kind)
{
}

AckMessage::AckMessage(const AckMessage& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
int AckMessage::getHostIndex() const
{
    return this->hostIndex;
}

void AckMessage::setHostIndex(int hostIndex)
{
    this->hostIndex = hostIndex;
}

int AckMessage::getTaskID() const
{
    return this->taskID;
}

void AckMessage::setTaskID(int taskID)
{
    this->taskID = taskID;
}

int AckMessage::getPartitionID() const
{
    return this->partitionID;
}

void AckMessage::setPartitionID(int partitionID)
{
...
AckMessageDescriptor::AckMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(task_offloading::AckMessage)), "veins::BaseFrame1609_4")
{
...
int AckMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "partitionID") == 0) return baseIndex + 2;
