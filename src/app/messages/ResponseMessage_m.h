...
class ResponseMessage : public ::veins::BaseFrame1609_4
{
  protected:
    ...
    double dataComputed = 0;
    double timeToCompute = 0;
    int taskID = 0;
    int partitionID = 0;
  ...
  public:
    ...
    virtual double getDataComputed() const;
    virtual void setDataComputed(double dataComputed);

    virtual double getTimeToCompute() const;
    virtual void setTimeToCompute(double timeToCompute);
