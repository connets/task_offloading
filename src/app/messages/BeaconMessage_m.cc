...
int BeaconMessage::getHostID() const
{
    return this->hostID;
}

void BeaconMessage::setHostID(int hostID)
{
    this->hostID = hostID;
}

const ::veins::LAddress::L2Type& BeaconMessage::getSenderAddress() const
{
    return this->senderAddress;
}

void BeaconMessage::setSenderAddress(const ::veins::LAddress::L2Type& senderAddress)
{
...
BeaconMessageDescriptor::BeaconMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(task_offloading::BeaconMessage)), "veins::BaseFrame1609_4")
{
