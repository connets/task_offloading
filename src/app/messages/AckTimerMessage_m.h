...
#include "ResponseMessage_m.h" // import ResponseMessage


namespace task_offloading {

/**
 * Class generated from <tt>app/messages/AckTimerMessage.msg:23</tt> by opp_msgtool.
 * <pre>
...
class AckTimerMessage : public ::veins::BaseFrame1609_4
{
  ...
  public:
    ...
    virtual const ResponseMessage * getData() const;
    virtual ResponseMessage * getDataForUpdate() { return const_cast<ResponseMessage *>(const_cast<AckTimerMessage*>(this)->getData());}
    virtual void setData(ResponseMessage * data);
};
