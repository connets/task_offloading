...
#ifndef __TIROCINIO_ACKMESSAGE_M_H
#define __TIROCINIO_ACKMESSAGE_M_H
...
template<> inline tirocinio::AckMessage *fromAnyPtr(any_ptr ptr) { return check_and_cast<tirocinio::AckMessage*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __TIROCINIO_ACKMESSAGE_M_H
