...
ResponseMessageDescriptor::ResponseMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(tirocinio::ResponseMessage)), "veins::BaseFrame1609_4")
{
