...
void ResponseMessage::copy(const ResponseMessage& other)
{
    ...
    this->timeToCompute = other.timeToCompute;
...
void ResponseMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->timeToCompute);
...
void ResponseMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->timeToCompute);
...
double ResponseMessage::getTimeToCompute() const
{
    return this->timeToCompute;
}

void ResponseMessage::setTimeToCompute(double timeToCompute)
{
    this->timeToCompute = timeToCompute;
}

int ResponseMessage::getTaskID() const
{
    return this->taskID;
}

void ResponseMessage::setTaskID(int taskID)
{
    this->taskID = taskID;
}

int ResponseMessage::getPartitionID() const
{
    return this->partitionID;
}

void ResponseMessage::setPartitionID(int partitionID)
{
...
unsigned int ResponseMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_timeToCompute
...
int ResponseMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "timeToCompute") == 0) return baseIndex + 3;
...
std::string ResponseMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_timeToCompute: return double2string(pp->getTimeToCompute());
...
void ResponseMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_timeToCompute: pp->setTimeToCompute(string2double(value)); break;
...
omnetpp::cValue ResponseMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_timeToCompute: return pp->getTimeToCompute();
...
void ResponseMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_timeToCompute: pp->setTimeToCompute(value.doubleValue()); break;
